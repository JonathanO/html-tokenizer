...
class ParseErrors {
  ...
  'unknown-named-character-reference' => 'getUnknownNamedCharacterReference',
        ...
        public static function getCdataInHtmlContent($line = 0, $col = 0) {
            return new ParseError("cdata-in-html-content", "cdata in html content", $line, $col);
        }
        ...
        public static function getEndTagWithAttributes($line = 0, $col = 0) {
            return new ParseError("end-tag-with-attributes", "end tag with attributes", $line, $col);
        }
        ...
        public static function getEndTagWithTrailingSolidus($line = 0, $col = 0) {
            return new ParseError("end-tag-with-trailing-solidus", "end tag with trailing solidus", $line, $col);
        }
        ...
        public static function getNonVoidHtmlElementStartTagWithTrailingSolidus($line = 0, $col = 0) {
            return new ParseError("non-void-html-element-start-tag-with-trailing-solidus", "non void html element start tag with trailing solidus", $line, $col);
        }
        ...
        public static function getSurrogateInInputStream($line = 0, $col = 0) {
            return new ParseError("surrogate-in-input-stream", "surrogate in input stream", $line, $col);
        }
